...
const CHECK_SCRIPTS = {
  ...
  make: {
    label: 'Make.com (global)',
    file: 'check-make-policy.js',
    emoji: '⚙️',
    niveau: 'warning',
    tables_concernees: null
  },
    ...
    activityLogger.log('sentinelle', 'verification', {
      ...
      details: {
        ...
        actions_recommandees: failedEntries.map(function(e) {
          ...
          if (k === 'watchdog') return 'Vérifier endpoint du Watchdog';
          if (k === 'make') return 'Vérifier dashboard Make.com et scénarios';
